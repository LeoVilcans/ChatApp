...
public static final String TABLE = "messages";
	...
	public static final String INSERT_QUERY = "INSERT INTO " + TABLE + " (room_id, text, sent_time, attachment, user_id) VALUES (?, ?, CURRENT_TIMESTAMP, ?, ?)";
    ...
    public static final String GET_SINCE_INDEX_QUERY = "SELECT * FROM " + TABLE + " WHERE room_id = ? AND id > ?";
    ...
    public static final String GET_BY_ROOM_QUERY = "SELECT * FROM " + TABLE + " WHERE room_id = ?";
    
    public static final String GET_BY_TIME_QUERY = "SELECT * FROM " + TABLE + " WHERE sent_time = ?";
